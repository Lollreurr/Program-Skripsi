...
def Naver(total_loop, percentage):
    ...
    filename = "D:\8. Other\Andreas\password_Finished.txt"
    ...
    for _ in range(total_loop):
        ...
        smml_model = calculate_smml_probabilities(passwords)
        smml_values, smml_transformed = calculate_smml(passwords, smml_model)
        ...
        # HSIMM dalam perhitungan SMML
        si_char_probs = calculate_self_information_probs(passwords)
        si_values = calculate_self_information(passwords, si_char_probs)
